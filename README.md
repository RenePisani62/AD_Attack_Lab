...
Conclusion: The LLMNR poisoning exercise was successfully reproduced on Windows 10. Under the same lab conditions, Windows 11 Pro 25H2 (Build 26200.8655) did not generate observable LLMNR, mDNS, or NBT-NS traffic in response to the same invalid hostname test. The cause was not conclusively identified and may relate to changes in the Windows 11 name-resolution stack or security hardening. Further investigation was deferred to allow progression through subsequent AD lab exercises.
